...
public class TestBigTransfer extends FTPTestCase {
     ...
     * Revision control id
     */
    public static String cvsId = "@(#)$Id: TestBigTransfer.java,v 1.1 2005/08/28 13:40:11 plexus Exp $";
    ...
    public void testTransferLarge() throws Exception {
        ...
        ftp.setTransferBufferSize(262143);
    ...
    private void bigTransfer(String bigFile) throws Exception {
        ...
        ftp.put(bigFile, bigFile);

        ftp.get(bigFile + ".copy", bigFile);

        // delete remote file
        ftp.delete(bigFile);
        
        // check equality of local files
        assertIdentical(bigFile + ".copy", bigFile);

        // and delete local file
        File local = new File(bigFile + ".copy");
        local.delete();
    }
