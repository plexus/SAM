...
public class TestPortRange extends FTPTestCase {
     ...
     * Revision control id
     */
    public static String cvsId = "@(#)$Id: TestPortRange.java,v 1.1 2005/08/28 13:40:11 plexus Exp $";
    ...
    public void testTransferBinary() throws Exception {
        ...
        if (!ftp.getConnectMode().equals(FTPConnectMode.ACTIVE))
            throw new Exception("Test only valid for ACTIVE mode");
        
        ftp.setActivePortRange(lowPort, highPort);
